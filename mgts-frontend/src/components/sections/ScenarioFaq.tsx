          ...
          {items.map((item: any, idx: number) => (
            ...
            >
              <summary className="flex items-center justify-between p-5 cursor-pointer list-none">
                <span className="font-bold text-primary dark:text-primary">{item.question}</span>
              ...
              {item.answer && (
                <div
                  className="px-5 pb-6 text-slate-700 dark:text-slate-300 text-sm leading-relaxed border-t border-primary/10 mt-1 pt-4"
