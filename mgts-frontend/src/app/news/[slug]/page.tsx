    ...
    <article>
      <section className="bg-background-light dark:bg-background-dark" data-stitch-block="breadcrumbs">
        <div className="max-w-[1200px] mx-auto px-4 lg:px-10 py-4">
          <nav className="flex items-center gap-2 text-sm font-medium">
            <a className="text-fg-subtle dark:text-fg-muted hover:text-accent-text transition-colors flex items-center gap-1" href="/">
              <span className="material-symbols-outlined text-base">home</span>
              Главная
            </a>
            <span className="material-symbols-outlined text-fg-muted text-sm">chevron_right</span>
            <a className="text-fg-subtle dark:text-fg-muted hover:text-accent-text transition-colors" href="/news">
              Раздел
            </a>
            <span className="material-symbols-outlined text-fg-muted text-sm">chevron_right</span>
            <span className="text-accent-text font-bold">Страница</span>
          </nav>
        </div>
      </section>
      <section
        className="bg-background-dark text-fg min-h-screen relative overflow-x-hidden"
      ...
      >
        ...
        <main className="max-w-[1100px] mx-auto px-8 py-12">
          <div className="mb-8">
            <a
              className="text-xs font-black uppercase tracking-widest text-accent-text hover:opacity-80 transition-opacity"
              href="/news/archive"
              data-news-back
            >
              ← Архив новостей
          ...
          <div className="flex flex-col gap-6">
            <p className="text-xs font-black uppercase tracking-[0.25em] text-fg-subtle" data-news-meta>
            ...
            <div
              className={`aspect-[16/9] rounded-2xl bg-fg/5 border border-fg/10 overflow-hidden ${
                imageUrl ? "" : "hidden"
              }`}
              data-cms-media
            >
