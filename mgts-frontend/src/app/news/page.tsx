...
type NewsListPageProps = {
  searchParams?: Promise<{ page?: string; tag?: string }> | { page?: string; tag?: string };
};
    ...
    <div className="news-list">
      ...
      <main className="max-w-7xl mx-auto px-6 py-12">
          <div className="mb-16 relative">
            ...
            <h1 className="text-6xl md:text-7xl font-black tracking-tighter mb-6 bg-gradient-to-br from-fg via-fg to-fg/30 bg-clip-text text-transparent">
              Новости и
              <br />
              Медиа-ресурсы
            </h1>
            <p className="text-fg-muted text-xl max-w-2xl font-light leading-relaxed">
