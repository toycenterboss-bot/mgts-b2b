...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    copyright: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u00A9 2025 \u041C\u0413\u0422\u0421. \u0412\u0441\u0435 \u043F\u0440\u0430\u0432\u0430 \u0437\u0430\u0449\u0438\u0449\u0435\u043D\u044B.'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiIconIcon extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: '\u0421\u043F\u0440\u0430\u0432\u043E\u0447\u043D\u0438\u043A Material Symbols \u0438\u043A\u043E\u043D\u043E\u043A';
    displayName: 'Icon';
    pluralName: 'icons';
    singularName: 'icon';
  };
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    deepNavTrees: Schema.Attribute.Component<'navigation.deep-nav-tree', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    logoAlt: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'\u041C\u0413\u0422\u0421'>;
    mainMenuItems: Schema.Attribute.Component<'navigation.menu-item', true>;
    megaMenuCta: Schema.Attribute.Component<'navigation.mega-menu-cta', false>;
    megaMenus: Schema.Attribute.Component<'navigation.mega-menu', true>;
    phone: Schema.Attribute.String & Schema.Attribute.DefaultTo<'+78002500250'>;
    phoneDisplay: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'8 800 250-0-250'>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNewsCategoryNewsCategory
  ...
  attributes: {
    color: Schema.Attribute.String & Schema.Attribute.DefaultTo<'#0066CC'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaKey: Schema.Attribute.String;
    deepNavKey: Schema.Attribute.String;
    hero: Schema.Attribute.Component<'page.hero', false>;
    heroBackgroundImage: Schema.Attribute.Media;
    heroSubtitle: Schema.Attribute.Text;
    heroTitle: Schema.Attribute.String;
    isMenuVisible: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    showNewsBlock: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    sidebar: Schema.Attribute.Enumeration<['none', 'about']> &
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    isFromOldSite: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::product.product'
    ...
    >;
    section: Schema.Attribute.Enumeration<
      ['business', 'operators', 'government', 'partners', 'developers']
    >;
    shortDescription: Schema.Attribute.Text & Schema.Attribute.Required;
