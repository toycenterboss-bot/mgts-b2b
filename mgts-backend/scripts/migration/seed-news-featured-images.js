/**
 * Attach featured images to latest news items.
 *
 * Usage:
 *   cd mgts-backend
...
module.exports = async function seedNewsFeaturedImages({ strapi }) {
  const files = [
    "60b54c10dd84.png",
    "6eeb437dfc85.png",
    "59b1b16623f4.png",
  ...
  const latestNews = await strapi.entityService.findMany("api::news.news", {
  ...
  let updated = 0;
  for (let i = 0; i < latestNews.length; i += 1) {
