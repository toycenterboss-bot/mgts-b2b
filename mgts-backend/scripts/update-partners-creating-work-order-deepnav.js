/**
 * Create/refresh deep-nav tree for partners_creating_work_order and set page deepNavKey.
 *
 * Usage:
 *   STRAPI_API_TOKEN=... node scripts/update-partners-creating-work-order-deepnav.js
 *
 * Env:
...
const DEEPNAV_KEY = 'partners_work_order';
const PAGE_SLUG = 'partners_creating_work_order';
