...
Владелец 17.08: **архивных съёмок не существует, их не делали.** Задним числом
не снимаются, поэтому Ф5 переезжает на 3D-модель. Но объекты строятся сейчас —
и через год фотослой можно наполнить, если начать снимать с ближайшего.
