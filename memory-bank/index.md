...
| `PLANNING-STANDARD.md` | **📐 Стандарт планирования:** 13 принципов, скелет плана, чек-листы метрики и вопроса, табло §0.0, таблица соответствия чужих номеров классов нашим. Имя такое же, как в проекте Investments — намеренно | — |
| `index.md` | Этот файл | — |
...
| `patterns/coverage.md` | Покрытие классов машинным наблюдением: ✅ 3 · 🟡 8 · ❌ 5. Сверять до того, как писать «инвариант сторожит К-NN» |
...
| Файл | О чём |
|---|---|
| `implementation-plans/README.md` | Реестр планов и правило «когда план вместо строки в бэклоге» |
| `implementation-plans/PLAN-01-редизайн-и-интеграция.md` | Редизайн и интеграция в Strapi по стандарту: табло §0.0, факты, 8 фаз с инвариантами и откатами, реестр заглушек, 21 мутация |
